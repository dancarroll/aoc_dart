...
void main() {
  ...
  group('sample data', tags: 'sample-data', () {
    ...
    test('part1', () async {
      expect(await part1.calculate(file), 357);
    });

    test('part2', () async {
      expect(await part2.calculate(file), 3121910778619);
    });
  });
  ...
  group('real data', tags: 'real-data', () {
    ...
    test('part1', () async {
      expect(await part1.calculate(file), 17301);
    });

    test('part2', () async {
      expect(await part2.calculate(file), 172162399742349);
    });
  });
}
