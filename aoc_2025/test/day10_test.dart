...
import 'package:aoc_2025/day10/part_1.dart' as part1;
import 'package:aoc_2025/day10/part_2.dart' as part2;
...
void main() {
  ...
  group('sample data', tags: 'sample-data', () {
    ...
    test('part2', () async {
      expect(await part2.calculate(file), 33);
    });
  });
  ...
  group('real data', tags: 'real-data', () {
    ...
    test('part1', () async {
      expect(await part1.calculate(file), 481);
    });

    test('part2', () async {
      expect(await part2.calculate(file), 20142);
    });
  });
}
