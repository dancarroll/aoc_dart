...
import 'package:aoc_2025/day9/part_1.dart' as part1;
import 'package:aoc_2025/day9/part_2.dart' as part2;
...
void main() {
  ...
  group('sample data', tags: 'sample-data', () {
    ...
    test('part1', () async {
      expect(await part1.calculate(file), 50);
    });
  ...
  group('real data', tags: 'real-data', () {
    ...
    test('part1', () async {
      expect(await part1.calculate(file), 4759420470);
    });
